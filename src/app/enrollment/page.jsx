                ...
                <AnimateOpacity>
                    <section className={styles.section}>
                        ...
                        <p style={{ textAlign: 'left' }}>
                            ...
                            If you are a currently enrolled family, there is no need to enroll for next year. Students who are invited to re-enroll will be enrolled automatically, and will have the option to withdraw if they choose not to return. You will receive information via email on updated enrollment dates and tuition before enrollment opens for the new year. If you need any information, contact <Link variant='contained' href='mailto: office@kardiaclassical.org'> <span style={{ color: 'green', fontWeight: 600 }}>office@KardiaClassical.org</span></Link>.
                        </p>
                    </section>
                </AnimateOpacity>
                <AnimateOpacity>
                    <section className={`${styles.section} ${styles.newFamSection}`}>
                        ...
                        <p style={{ textAlign: 'left' }}>
                            ...
                            >
                               click here
                            </a> to access the new family application (see below for instructions on how to navigate the admissions platform). This link will redirect you to our online application portal. Once you have completed the online application and submitted all required signed forms, you will be emailed regarding next steps. To fully save your place, you will need to pay enrollment fees listed on our tuition document.
                        </p>
                    </section>
                </AnimateOpacity>
                <AnimateOpacity>
