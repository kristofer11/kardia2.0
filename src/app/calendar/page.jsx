            ...
            <article className={`page-content`}>
                <AnimateOpacity>
                    <section className={styles.section}>
                        <h1>Calendar</h1>
                        <p >
                            Here is the calendar for the 2026-2027 School Year! Please keep in mind that dates are subject to change, however, we will give plenty of notice if anything needs to be adjusted. Whenever there are changes to the calendar, it will be updated here as well.<br /><strong>Click on the calendar below to <Link href='downloads/calendar-26.pdf' download='2025-2026 Kardia Calendar.pdf' target='_blank'>download</Link>.</strong>
                        </p>
                        <Link
